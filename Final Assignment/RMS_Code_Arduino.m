...
% Paired t-test
[h, p, ci, stats] = ttest(emg_rms, emg_rms_treat(1:13184.1), "Tail","both");
...
num_epochs = floor(length(emg_filt) / epoch_len);
data_epochs = reshape(emg_filt(1:num_epochs*epoch_len), epoch_len, num_epochs);
